                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if ( error ) {//非图片
                        if(file.type.indexOf('text/') >= 0){
                            img = $('<img src="teacher/images/txt.png">');
                        }else if(file.name.indexOf('.doc')>=0){
                            img = $('<img src="teacher/images/doc.png">');
                        }else if(file.name.indexOf('.pdf')>=0){
                            img = $('<img src="teacher/images/pdf.png">');
                        }else if(file.name.indexOf('.rar')>=0||file.name.indexOf('.zip')>=0){
                            img = $('<img src="teacher/images/yasuo.png">');
                        }else {
                            img = $('<img src="teacher/images/unknown.png">');
                        }
                    }else{//图片
                        if( isSupportBase64 ) {
                            img = $('<img src="'+src+'">');
